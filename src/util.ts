...
const contractAddress = '0xa50380dDEE64d53cfe6C8eAd09Cb99136D19628f';
...
export async function connectMetaMask(proposerContractAddress: string,  proposerTokenId: number,account: string) {
    try {
        ...
        const result = await contractGenofusion.mint(mintParams,1,signature,{value:ethers.utils.parseEther("0.01"),gasLimit:5000000})
        console.log('result',result)
    } catch (error) {
        console.error("Error connecting to MetaMask:", error);
    }
